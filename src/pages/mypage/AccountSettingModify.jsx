...
const AccountSettingModify = ({setIsModifyClicked, userData, setIsComplete}) => {
    ...
    const handleSave = async () => {
        try {
            // 서버 API 엔드포인트
            const apiUrl = 'http://api.mannazu.com/api/v1/user';
    ...
    return(
        <>
            ...
            <div>
                ...
                <input type='text' id='nickname' value={formData.nickname}
                       onChange={handleChange}
                />
            </div>
            <div>
                <label htmlFor='nationality'>국적: </label>
                <input type='text' id='nationality' value={formData.nationality}
                       onChange={handleChange}
                />
            </div>
            <div>
                <label htmlFor='language'>언어: </label>
                <input type='text' id='language' value={formData.language}
                       onChange={handleChange}
                />
            </div>
            <div>
                <label htmlFor='introduction'>소개: </label>
                <input type='text' id='introduction' value={formData.introduction}
                       onChange={handleChange}
                />
            </div>
            <div>
            ...
            <div>
                ...
                <input type='text' id='mbti' value={formData.mbti}
                       onChange={handleChange}
                />
            </div>
            <div>
                <label htmlFor='interests'>흥미: </label>
                <input type='text' id='interests' value={formData.interests}
                       onChange={handleChange}
                />
            </div>
